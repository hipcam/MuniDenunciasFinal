...
public class ReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ubicacionInput = findViewById(R.id.location_input);
    }
    ...
    public void callReport(View view) {
        ...
        String id = idciudadano;
        String ubicacion = ubicacionInput.getText().toString();

        if (titulo.isEmpty() || desc.isEmpty() || ubicacion.isEmpty()) {
            Toast.makeText(this, "Título, descripción y ubicación son campos requeridos", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createReporte(id, titulo, desc, ubicacion);
        } else {
            ...
            call = service.createReporteWithImage(idPart, tituloPart, descPart, ubicacionPart, imagenPart);
        }
            ...
            public void onResponse(Call<ResponseMessage> call, Response<ResponseMessage> response) {
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(ReportActivity.this, responseMessage.getMessage(), Toast.LENGTH_LONG).show();
                        finish();
